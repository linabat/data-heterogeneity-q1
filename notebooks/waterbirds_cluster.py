...
def main():
    ...
    output_csv = "p_y_place_data.csv"
    p_y_place_df.to_csv(output_csv, index=False)
    print(f"Data saved to {output_csv}")

    # This is to visualize the different clusters 
    p = p1_tr
    def visualization_images(p_value, y_value):
        """
    ...
    visualization_images(1, 0)
    visualization_images(1, 1)
    visualization_images(0, 1)
    visualization_images(0, 0)
